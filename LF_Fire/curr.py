...
if __name__ == "__main__":
	...
	for i in range(no_of_environmets):
		...
		env = gym.make(env_id, map_width = width, map_height = height, items_quantity = {'tree': no_trees, 'rock': no_rocks, 'fire': is_fire, 'crafting_table': crafting_table, 'stone_axe':0},
			initial_inventory = {'wall': 0, 'tree': starting_trees, 'rock': starting_rocks, 'fire': 0, 'crafting_table': 0, 'stone_axe':0}, is_fire = is_fire, goal_env = type_of_env, is_final = final_status)
