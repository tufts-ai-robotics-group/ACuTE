...
if __name__ == "__main__":
	...
	env = gym.make(env_id, map_width = 10, map_height = 10, items_quantity = {'tree': 3, 'rock': 2, 'fire': 0, 'crafting_table': 0, 'pogo_stick':0},
		initial_inventory = {'wall': 0, 'tree': 0, 'rock': 0, 'fire': 0, 'crafting_table': 0, 'pogo_stick':0}, is_fire = 0,  goal_env = 2, is_final = False)
