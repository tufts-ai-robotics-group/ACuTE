...
plt.ylim([-900,900])
plt.scatter(curriculum_shifted_timestep_arr[:x_count-1], curriculum_shifted_reward_arr[:x_count-1], marker = 'o', label = 'Curriculum')
plt.errorbar(curriculum_shifted_timestep_arr[:x_count-1], curriculum_shifted_reward_arr[:x_count-1], yerr = std_dev_curr[:x_count])
